...
const segmentosTemp = [
  {   
    segmento_id: "6",
    segmento_nombre: "NAKED"
  },
  {   
    segmento_id: "10",
    segmento_nombre: "SUPERSPORT"
  },
  {   
    segmento_id: "7",
    segmento_nombre: "TRAVEL"
  }
]

  return (
    <div className="container mt-4">
      <div className="row row__CatalogoMoto" style={{ backgroundColor: '#fff' }}>
        <p className="Titlulo__CatalogoMoto">MOTOCICLETAS</p>
        {segmentosTemp.map((item) => {
      ...
      <div className="text-end container-fluid mb-3">
        ...
        <button className="btn btnfiltros" data-bs-toggle="modal" data-bs-target="#filtroModal">
          Mostrar Filtros
        </button>
      </div>
      ...
      {productosParaMostrar.length > 0 && productosParaMostrar.length < productosFiltrados.length && (
        <div className="text-center mt-4">
          <button className="btn  btn__mostrarMas" onClick={cargarMas}>
              ...
              >
                ...
                <div className="modal-footer" style={{ borderTop: "1px solid #dee2e6" }}>
                  <button
                    ...
                    onClick={() => setProductoSeleccionado(null)}
                    style={{ background: "#bb1622", color: "white", border: "none" }}
                  >
                    Cerrar
                  </button>
                </div>
